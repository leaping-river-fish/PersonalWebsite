...
function Contact() {
    ...
    return (
      <div className="page-container">
              ...
              <section className="contact-container">
                ...
                <div className="contact-content">
                  ...
                  <div className="contact-info">
                    <h2>Get in Touch</h2>
                    <p>Email: <a href="mailto:nickzheng81@gmail.com">nickzheng81@gmail.com</a></p>
                    <p>Phone: <a href="tel:+16478658629">+1 (647) 865-8629</a></p>
          ...
          <p>&copy; 2025 Nick Zheng. All Rights Reserved.</p>
          </footer>
        </div>
      );
    };
